...
export const UI = {
  ...
  friendsSearchPlaceholder: "Pseudo @handle ou prénom…",
  friendsSearchHint: "Recherche par @pseudo exact ou par prénom / nom.",
  friendsSearchEmpty: "Tape un pseudo ou un nom pour chercher.",
