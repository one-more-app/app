...
export const UI = {
  ...
  eventAdminPasswordPrompt: "Mot de passe stand",
  eventAdminPasswordPlaceholder: "Mot de passe",
  eventAdminPasswordSubmit: "Accéder",
  eventAdminPasswordWrong: "Mot de passe incorrect.",
  ...
  eventAdminCelebrationOnTv: "En direct sur la télé",
  eventAdminCelebrationDismiss: "Retirer l'affichage TV",
  eventAdminCelebrationDismissed: "Affichage retiré.",
  eventAdminCelebrationHint:
    "L'écran reste bloqué sur la célébration tant que tu n'as pas validé.",
