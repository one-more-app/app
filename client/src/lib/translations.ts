...
export const UI = {
  ...
  onboardingDiscoveryTitle: "Comment as-tu découvert One More ?",
  onboardingDiscoveryContinue: "Continuer",
  onboardingDiscoveryOtherPlaceholder: "Précise…",
  onboardingDiscoveryAppStore: "App Store",
  onboardingDiscoveryPlayStore: "Play Store",
  onboardingDiscoveryAppStores: "App Store ou Play Store",
  onboardingDiscoveryGoogleWeb: "Recherche Google ou article web",
  onboardingDiscoveryFriendsFamily: "Amis ou famille",
  onboardingDiscoverySectionSocial: "Réseaux sociaux",
  onboardingDiscoverySectionAi: "IA",
  onboardingDiscoveryTiktok: "TikTok",
  onboardingDiscoveryInstagram: "Instagram",
  onboardingDiscoveryYoutube: "YouTube",
  onboardingDiscoveryInfluencer: "Influenceur",
  onboardingDiscoveryChatgpt: "ChatGPT",
  onboardingDiscoveryClaude: "Claude",
  onboardingDiscoveryGemini: "Gemini",
  onboardingDiscoveryPerplexity: "Perplexity",
  onboardingDiscoveryOther: "Autre",
  onboardingNotificationsTitle: "Suis les perfs de tes potes",
  onboardingNotificationsBody:
    "On te prévient quand un ami s'entraîne ou bat un record.",
  onboardingNotificationsMockSessionTitle: "Séance en cours",
  onboardingNotificationsMockSessionBody: "Ambre s'entraîne · squat",
  onboardingNotificationsMockSessionTime: "maintenant",
  onboardingNotificationsMockRecordTitle: "Nouveau record",
  onboardingNotificationsMockRecordBody: "Tony · hammer curl",
  onboardingNotificationsMockRecordTime: "il y a 1 min",
  onboardingNotificationsMockStreakTitle: "Série en danger",
  onboardingNotificationsMockStreakBody:
    "Ta série de 7 jours expire ce soir. Une séance suffit !",
  onboardingNotificationsMockStreakTime: "il y a 3 min",
  onboardingNotificationsMockReactionTitle: "Réaction sur ta séance",
  onboardingNotificationsMockReactionBody: "Léa a réagi 🔥 sur ta séance",
  onboardingNotificationsMockReactionTime: "il y a 8 min",
  onboardingNotificationsCta: "Activer les notifications",
  onboardingNotificationsCtaWeb: "Dispo sur l'app",
