...
export const UI = {
  ...
  notifRefreshToken: "Rafraîchir le token push",
  notifRefreshTokenOk: "Token push régénéré",
  notifTestPush: "Envoyer une notification test",
  notifTestPushOk: "Notification test envoyée",
  notifTestPushError: "Échec envoi test — voir la console",
