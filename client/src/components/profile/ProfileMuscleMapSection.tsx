                                            ...
                                            <li key={row.trackedExerciseId}>
                                                {readOnly ? (
                                                    ...
                                                    <Link
                                                        ...
                                                        className="flex items-center justify-between gap-2 rounded-md bg-card px-2 py-2 text-sm outline-none transition-colors hover:opacity-90 focus-visible:ring-2 focus-visible:ring-ring"
                                                    >
                                                        <span className="min-w-0 truncate capitalize">
                                                            {row.name}
                                                        </span>
