...
export function EventSpectacleOverlayShell({
  ...
  return (
    ...
    >
      ...
      <header className="relative z-10 flex w-full max-w-6xl flex-col items-center gap-5 text-center lg:gap-6">
        <OnboardingReveal delayMs={stagger}>
          <img
            src={logoText}
            alt="One More"
            className="h-8 w-auto opacity-90 lg:h-10"
          />
        </OnboardingReveal>
