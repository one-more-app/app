...
> = {
  bench: {
    male: [
      { ratio: 0, label: 'Fer' },
      { ratio: 0.14, label: 'Bronze' },
      { ratio: 0.28, label: 'Argent' },
      { ratio: 0.43, label: 'Or' },
      { ratio: 0.57, label: 'Platine' },
      { ratio: 0.71, label: 'Émeraude' },
      { ratio: 0.86, label: 'Diamant' },
      { ratio: 1.0, label: 'Maître' },
      { ratio: 1.14, label: 'Elite' },
