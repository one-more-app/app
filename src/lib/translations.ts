...
export const UI = {
  ...
  noTrackedDescription: 'Ajoutez des exercices pour commencer à suivre vos performances',
  ...
  page: 'Page',
  apiErrorCustom: 'Vous pouvez créer des exercices personnalisés avec le bouton « Personnalisé ».',
