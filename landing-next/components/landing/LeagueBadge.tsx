...
import { LEAGUE_COLORS, UI } from "@/lib/landing-data";
...
export function LeagueBadge({
    ...
    return (
        <div className="rounded-lg space-y-4">
            ...
            <div className={`rounded-lg p-3 justify-start items-start text-left ${oneRMStyle}`}>
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center gap-2 text-xs text-muted-foreground">
                        <span className="flex items-center gap-1.5">
                            {league.weightTierStart.toFixed(1)}
                            {weightSuffix}
                        ...
                        <span className="flex items-center gap-1.5">
                            {league.weightTierEnd != null ? (
                                <>
                                    {league.weightTierEnd.toFixed(1)}
                                    {weightSuffix}
