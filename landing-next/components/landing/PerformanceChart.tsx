...
import type { PerformanceEntry } from "@/lib/landing-data";
                    ...
                    <Tooltip
                        ...
                        labelFormatter={(_, payload) =>
                            payload[0]?.payload?.fullDate
                                ? new Date(payload[0].payload.fullDate).toLocaleDateString("fr-FR", {
                                    weekday: "long",
                                    day: "numeric",
                                    month: "long",
                                })
                        ...
                        formatter={(
                            ...
                            const weightLabel =
                                value === 0
                                    ...
                                    : `${value} kg`;
                            const label =
                                reps != null ? `${weightLabel} × ${reps} reps` : weightLabel;
                            return [label, ""];
                        }}
                    />
                    <Line
